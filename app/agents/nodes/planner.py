...
def planner_node(state: AgentState):
    ...
    2. If it is a technical question about Kubernetes,python,java, AI, LLM, Intel, or Networking that requires fresh documentation, output a refined search query.
